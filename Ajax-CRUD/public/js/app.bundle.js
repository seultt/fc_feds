...
(function () {
  ...
  var putBtn = document.querySelector('#putBtn');
  ...
  getBtn.addEventListener('click', function () {
    ...
    _ajax2.default.getUsers('/users/' + userid).then(function (res) {
      console.log('responseText: ', res, typeof res === 'undefined' ? 'undefined' : _typeof(res));
  ...
  postBtn.addEventListener('click', function () {
    var userid = document.querySelector('#user_id').value;
    var userpw = document.querySelector('#user_pw').value;
    var userFirst = document.querySelector('#user_first').value;
    var userLast = document.querySelector('#user_last').value;
